!function() {
        ...
        return function(u, i) {
            ...
            var g, p, v, d = t(i), m = u.invert(r[0], r[1]), y = {
                ...
                polygonEnd: function() {
                    ...
                    b = !0),
                    Lt(g, jt, n, e, i)) : n && (b || (i.polygonStart(),
                    b = !0),
                    i.lineStart(),
                    e(null , null , 1, i),
                    i.lineEnd()),
    ...
    function Ut(n) {
        ...
        return {
            ...
            point: function(i, a) {
                var o = i > 0 ? ja : -ja
                  , l = Ma(i - e);
                Ma(l - ja) < Da ? (n.point(e, r = (r + a) / 2 > 0 ? Ha : -Ha),
                n.point(u, r),
                n.lineEnd(),
                n.lineStart(),
                n.point(o, r),
                n.point(i, r),
                t = 0) : u !== o && l >= ja && (Ma(e - u) < Da && (e -= u * Da),
                Ma(i - o) < Da && (i -= o * Da),
                r = Ft(e, r, i, a),
                n.point(u, r),
                n.lineEnd(),
    ...
    function It(n) {
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                k = N,
                N = _),
                C ? A ? k + N > 0 ^ b[1] < (Ma(b[0] - w) < Da ? k : N) : k <= b[1] && b[1] <= N : E > ja ^ (w <= b[0] && b[0] <= S)) {
                    var z = xt(d, (-m + x) / y);
                    return Mt(z, p),
                    [b, _t(z)]
                }
    ...
    function ri(n, t, e, r) {
        ...
        a.tickFormat = function(n, t) {
            ...
            var r, o = Math.max(.1, n / a.ticks().length), l = e ? (r = 1e-12,
            Math.ceil) : (r = -1e-12,
            Math.floor);
            return function(n) {
